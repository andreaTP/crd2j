...
public class KameletList implements KubernetesResource, KubernetesResourceList<io.fabric8.camelk.v1alpha1.Kamelet>
{
     ...
     */
    @JsonProperty("kind")
    private String kind = "KameletList";
     ...
     * @param items
     */
    public KameletList(String apiVersion, List<io.fabric8.camelk.v1alpha1.Kamelet> items, String kind, ListMeta metadata) {
        super();
    ...
    @JsonProperty("items")
    public List<io.fabric8.camelk.v1alpha1.Kamelet> getItems() {
        return items;
    }

    @JsonProperty("items")
    public void setItems(List<io.fabric8.camelk.v1alpha1.Kamelet> items) {
        this.items = items;
    }
