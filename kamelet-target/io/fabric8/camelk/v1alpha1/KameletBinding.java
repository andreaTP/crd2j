...
public class KameletBinding implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public KameletBinding(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, KameletBindingSpec spec, KameletBindingStatus status) {
        super();
