...
public class KameletBindingList implements KubernetesResource, KubernetesResourceList<io.fabric8.camelk.v1alpha1.KameletBinding>
{
     ...
     */
    @JsonProperty("kind")
    private String kind = "KameletBindingList";
     ...
     * @param items
     */
    public KameletBindingList(String apiVersion, List<io.fabric8.camelk.v1alpha1.KameletBinding> items, String kind, ListMeta metadata) {
        super();
    ...
    @JsonProperty("items")
    public List<io.fabric8.camelk.v1alpha1.KameletBinding> getItems() {
        return items;
    }

    @JsonProperty("items")
    public void setItems(List<io.fabric8.camelk.v1alpha1.KameletBinding> items) {
        this.items = items;
    }
