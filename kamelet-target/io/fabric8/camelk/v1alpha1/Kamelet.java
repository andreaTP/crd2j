...
public class Kamelet implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public Kamelet(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, KameletSpec spec, KameletStatus status) {
        super();
    ...
    @JsonProperty("status")
    public KameletStatus getStatus() {
        return status;
    }

    @JsonProperty("status")
    public void setStatus(KameletStatus status) {
        this.status = status;
    }
